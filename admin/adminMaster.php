                    ...
                    <div class="row row-group m-0">
                        <div class="col-12 col-lg-6 col-xl-3 border-light">
                            <div class="card-body">
                                ...
                                <p class="mb-0 text-white small-font">Pelayanan<span class="float-right">+4.2% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 col-xl-3 border-light">
                            <div class="card-body">
                                ...
                                <p class="mb-0 text-white small-font">Penghasilan<span class="float-right">+1.2% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 col-xl-3 border-light">
                            <div class="card-body">
                        ...
                        <div class="col-12 col-lg-6 col-xl-3 border-light">
                            <div class="card-body">
                                ...
                                <div class="progress my-3" style="height:3px;">
                                    <div class="progress-bar" style="width:<?= $no * 100 / 514 ?>%"></div>
                                </div>
                                <p class="mb-0 text-white small-font">Admin<span class="float-right">+<?= round($no * 100 / 514, 2) ?>%<i class="zmdi zmdi-long-arrow-up"></i></span></p>
                            </div>
                        </div>
                    </div>
                </div>
